package cn.cosx.blog.notice.facade;
...
import cn.cosx.blog.notice.exception.NoticeErrorCodeEnum;
...
public class NoticeFacadeServiceImpl implements NoticeFacadeService {
    ...
    public Response<String> sendAndGetCaptcha(String email) {
        ...
        //保存验证码到Redis
        redisTemplate.opsForValue().set(CaptchaConstants.CAPTCHA_KEY + email, captcha, 5, TimeUnit.MINUTES);

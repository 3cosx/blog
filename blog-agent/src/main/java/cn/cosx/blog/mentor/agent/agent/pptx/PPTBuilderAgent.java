package cn.cosx.blog.mentor.agent.agent.pptx;

import cn.cosx.blog.mentor.agent.agent.BaseAgent;
import cn.cosx.blog.mentor.agent.agent.pptx.strategy.PptStateStrategyContext;
import cn.cosx.blog.mentor.agent.agent.pptx.strategy.PptStateStrategyFactory;
import cn.cosx.blog.mentor.agent.entity.record.pptx.*;
import cn.cosx.blog.mentor.agent.service.AiPptInstService;
import cn.cosx.blog.mentor.agent.service.AiPptTemplateService;
import cn.cosx.blog.mentor.agent.service.PptPythonRenderService;
import cn.cosx.blog.mentor.agent.entity.AiSession;
import cn.cosx.blog.mentor.agent.entity.vo.SaveQuestionRequest;
import cn.cosx.blog.mentor.agent.entity.vo.UpdateAnswerRequest;
import cn.cosx.blog.mentor.agent.service.AgentTaskManager;
import cn.cosx.blog.mentor.agent.service.AiSessionService;
import cn.cosx.blog.mentor.agent.service.MinioService;
import cn.cosx.blog.mentor.agent.utils.AppContextClient;
import cn.cosx.blog.mentor.agent.utils.ImageGenerationService;
